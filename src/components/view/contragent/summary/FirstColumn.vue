  ...
  <div class="col-span-2">
        <div class="bg-white p-5 rounded-3xl mb-4">
          ...
          <div class="flex flex-col gap-10">
            <div>
              ...
              <p>
                Торговля розничная преимущественно пищевыми продуктами, включая напитки, и табачными
                изделиями в неспециализированных магазинах (47.11)
              </p>
            </div>
            ...
            <div>
              ...
              <span
                >350002, Краснодарский край, город Краснодар, ул. Им. Леваневского, д. 185 Еще 6
                организаций по этому адресу 
              </span>
            </div>
            ...
            <div>
              ...
              <span>Акционерное общество АО </span>
            </div>
            ...
            <div>
              ...
              <span>Инспекция ФНС России №2 по г. Краснодару с 28 июня 1996 г. </span>
            </div>
            ...
            <div>
              ...
              <span
                >ОКПО 41351125<br />
                ОКАТО 03401369000<br />
                ОКТМО 03701000001<br />
                ОКФС 16<br />
                Частная собственность<br />
                ОКОГУ 4210014<br />
                Организации, учрежденные юридическими лицами или гражданами, или юридическими лицами
                и гражданами совместно<br />
                ОКОПФ 12267<br />
                Непубличные акционерные общества<br />
              </span>
            </div>
          ...
          <div class="px-5">
            <div class="flex items-center justify-between mb-10">
              <div class="flex flex-col items-center gap-3">
                <h2 class="text-lg font-bold mb-4">Выручка</h2>
                <app-input class="w-32" />
                <span>+ 17 %</span>
              </div>

              <div class="flex flex-col items-center gap-3">
                <h2 class="text-lg font-bold mb-4">Себестоимость</h2>
                <app-input class="w-32" />
                <span>- 35 %</span>
              </div>

              <div class="flex flex-col items-center gap-3">
                <h2 class="text-lg font-bold mb-4">Прибыль</h2>
                <app-input class="w-32" />
                <span>+ 35 %</span>
              </div>
            </div>
        ...
        <div class="bg-white p-5 rounded-3xl px-10">
          ...
          <p class="text-xl mb-20">
            Похожие организации подбираются на основе совпадения основного вида деятельности и
